...
if __name__ == "__main__":
    ...
    pipe1 = make_pipeline(
        ...
        CreateUpdateArtifact("./data", None, "train_targets", filepath, True),
    )
    pipe1.fit_transform(train_data)
    ...
    pipe2 = make_pipeline(
        ...
        CreateUpdateArtifact("./data", None, "train_rosters", filepath, True),
    )
    ...
    pipe3 = make_pipeline(
        ...
        CreateUpdateArtifact("./data", None, "train_awards", filepath, True),
    )
    ...
    pipe4 = make_pipeline(
        ...
        CreateUpdateArtifact("./data", None, "train_scores", filepath, True),
    )
    ...
    pipe42 = make_pipeline(
        ...
        CreateUpdateArtifact("./data", None, "train_scores_max", filepath, True),
    )
    ...
    pipe43 = make_pipeline(
        ...
        CreateUpdateArtifact("./data", None, "train_scores_sum", filepath, True),
    )
    ...
    pipe44 = make_pipeline(
        ...
        CreateUpdateArtifact("./data", None, "train_scores_mean", filepath, True),
    )
    ...
    pipe5 = make_pipeline(
        ...
        CreateUpdateArtifact("./data", None, "train_twitter", filepath, True),
    )
    ...
    pipe6 = make_pipeline(
        ...
        CreateUpdateArtifact("./data", None, "train_transactions", filepath, True),
    )
